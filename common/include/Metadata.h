...
#define META_NAME			"Nintendont (Disc-only Fork)"
...
#define META_LONG2			"Nintendont allows you to run GameCube games on a Wii or Wii U from an SD or HDD device. This fork adds the option to immediately boot from the Wii disc drive."
